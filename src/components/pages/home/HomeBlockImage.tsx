...
import { IHomeBlockImage } from '@/components/pages/home/home.interface';
import styles from './home.module.scss';

export function HomeBlockImage({ image }: IHomeBlockImage): JSX.Element {
	const links = [
	...
	return (
		<div className={styles.homeBlockWrapper}>
			<Image src={image} alt={'Poster'} className={styles.poster} />
			<div
